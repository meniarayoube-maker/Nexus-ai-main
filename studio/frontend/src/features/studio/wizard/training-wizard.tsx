...
import { CustomOutputPathSection } from "./custom-output-path-section";
import { ResumeCheckpointSection } from "./resume-checkpoint-section";
...
export function TrainingWizard({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Resume from Checkpoint — near model selection.
          The section hides itself when there are no resumable runs. */}
      <ResumeCheckpointSection />

      <CustomOutputPathSection />
