...
export const ar = {
  ...
  studio: {
    ...
    params: {
      ...
      autoSaveTooltip:
        "المفتاح الرئيسي لنقاط الحفظ الدورية. التعطيل يصفّر الفاصل؛ التفعيل يستعيد آخر فاصل استخدمته.",
      ddpEnabled: "تعدد GPUs (DDP)",
      ddpEnabledTooltip:
        "تكرار النموذج على كل بطاقة والتدريب بالتوازي (NCCL). التعطيل يُبقي الوضع الافتراضي المجزأ أحادي العملية. يوسّع حجم الدفعة الفعال بعدد البطاقات.",
