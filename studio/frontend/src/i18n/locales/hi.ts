...
export const hi = {
  ...
  studio: {
    ...
    params: {
      ...
      autoSaveTooltip:
        "आवधिक चेकपॉइंट का मुख्य स्विच। बंद करने पर अंतराल 0 हो जाता है; चालू करने पर आपका अंतिम अंतराल बहाल होता है।",
      ddpEnabled: "मल्टी-GPU (DDP)",
      ddpEnabledTooltip:
        "मॉडल को हर GPU पर दोहराएं और समानांतर प्रशिक्षण करें (NCCL)। बंद होने पर डिफ़ॉल्ट एकल-प्रक्रिया मोड रहता है। प्रभावी बैच आकार GPU संख्या के अनुसार बढ़ता है।",
