...
export const ru = {
  ...
  studio: {
    ...
    params: {
      ...
      autoSaveTooltip:
        "Главный переключатель периодических чекпоинтов. Выкл. ставит интервал 0; вкл. возвращает твой последний интервал.",
      ddpEnabled: "Мульти-GPU (DDP)",
      ddpEnabledTooltip:
        "Реплицирует модель на каждый GPU и обучает параллельно (NCCL). Выкл. сохраняет однопроцессный режим по умолчанию. Масштабирует эффективный размер батча по числу GPU.",
